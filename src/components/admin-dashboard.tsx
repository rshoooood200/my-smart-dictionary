...
// مجموعة الأيقونات المتنوعة لمختلف المواضيع
const ICON_CATEGORIES = {
  ...
  nature: {
    name: 'الطبيعة والطقس',
    icons: ['🌻', '🌼', '🌷', '🌹', '🥀', '🌺', '🌸', '💐', '🌱', '🌲', '🌳', '🌴', '🌵', '🌾', '🌿', '☘️', '🍀', '🍁', '🍂', '🍃', '☀️', '🌤️', '⛅', '🌥️', '☁️', '🌦️', '🌧️', '⛈️', '🌩️', '🌨️', '❄️', '☃️', '⛄', '🌬️', '💨', '🌪️', '🌫️', '🌈', '🌊', '💧', '💦', '🫧', '🔥', '💥', '☄️', '🌙', '🌚', '🌛', '🌜', '☀️', '🌞', '⭐', '🌟', '🌠', '🌌', '🌍', '🌎', '🌏', '🪐', '🛸', '🚀', '🛰️', '✨', '💫']
  },
  // المواصلات والسفر
  transport: {
    name: 'المواصلات والسفر',
  ...
  jobs: {
    name: 'المهن والأعمال',
    icons: ['💼', '📊', '📈', '📉', '🧾', '💰', '💵', '💴', '💶', '💷', '💸', '💳', '🧾', '💎', '⚖️', '🧰', '🔧', '🔨', '⚒️', '🛠️', '⛏️', '🔩', '⚙️', '🧱', '🏗️', '🏭', '🏢', '🏬', '🏪', '🏦', '🏨', '🏥', '🏫', '🏛️', '⛪', '🕌', '🕍', '🛕', '🕋', '⛩️', '🛤️', '🛣️', '🗾', '🎑', '🏙️', '🌆', '🌇', '🌃', '🌉', '🎠', '🎡', '🎢', '🎪', '🚂', '🚃', '🚄', '🚅', '🚆', '🚇', '🚈', '🚉', '🚊', '🚝', '🚞', '🚋', '🚌', '🚍', '🚎', '🚐', '🚑', '🚒', '🚓', '🚔', '🚕', '🚖', '🚗', '🚘', '🚙', '🚚', '🚛', '🚜', '🏎️', '🏍️', '🛵', '🚲', '🛴', '🛹', '🛼', '✈️', '🛫', '🛬', '🛩️', '🚁', '🛸', '🚀', '🛰️', '🛶', '⛵', '🚤', '🛥️', '🛳️', '⛴️', '🚢']
  },
  // التقنية والحاسوب
  technology: {
    name: 'التقنية والحاسوب',
    icons: ['💻', '🖥️', '⌨️', '🖱️', '💾', '💿', '📀', '📱', '📲', '☎️', '📞', '📟', '📠', '🔋', '🔌', '💡', '🔦', '📺', '📻', '摄像机', '📷', '📸', '📹', '🎥', '📽️', '🎬', '📡', '🛰️', '🚀', '🛸', '🤖', '🦾', '🦿', '🧠', '👾', '🎮', '🕹️', '🎯', '🎲', '🧩', '🎰', '🃏', '🀄', '🎴', '♟️', '🪀', '🪁', '🧸', '🪆', '🪅', '🎨', '🖌️', '✏️', '✒️', '🖊️', '🖍️', '📝', '💼', '📁', '📂', '🗂️', '📅', '📆', '🗒️', '🗓️', '📇', '📈', '📉', '📊', '📋', '📌', '📍', '📎', '🖇️', '📏', '📐', '✂️', '🗃️', '🗄️', '🗑️', '🔒', '🔓', '🔏', '🔐', '🔑', '🗝️']
  },
  // العواطف والتعبيرات
  emotions: {
    name: 'العواطف والتعبيرات',
    icons: ['😀', '😃', '😄', '😁', '😆', '😅', '🤣', '😂', '🙂', '🙃', '🫠', '😉', '😊', '😇', '🥰', '😍', '🤩', '😘', '😗', '☺️', '😚', '😙', '🥲', '😋', '😛', '😜', '🤪', '😝', '🤑', '🤗', '🤭', '🤫', '🤔', '🫡', '🫢', '🫣', '🤨', '😐', '😑', '😶', '🫥', '😏', '😒', '🙄', '😬', '😮', '🤯', '😱', '🥵', '🥶', '😰', '😓', '🤤', '🥴', '😵', '🫨', '🤢', '🤮', '🤧', '🤒', '🤕', '🥺', '🥹', '😭', '😢', '😿', '😩', '😫', '🥱', '😤', '😡', '😠', '🤬', '😈', '👿', '💀', '☠️', '💩', '🤡', '👹', '👺', '👻', '👽', '👾', '🤖', '😺', '😸', '😹', '😻', '😼', '😽', '🙀', '😿', '😾', '🙈', '🙉', '🙊', '💋', '💌', '💘', '💝', '💖', '💗', '💓', '💞', '💕', '💟', '❣️', '💔', '❤️', '🧡', '💛', '💚', '💙', '💜', '🖤', '🤍', '🤎', '🩷', '🩵']
  },
        ...
        <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
                        ...
                        <input
                          ...
                          onChange={async (e) => {
                            ...
                            try {
                              ...
                              const data = await response.json()
                              console.log('Upload success:', data.pdfUrl)

                              setLessonForm(prev => ({
                                ...prev,
                                pdfUrl: data.pdfUrl,
                                pdfTitle: data.pdfTitle || lessonForm.title || file.name.replace('.pdf', ''),
                                pdfTitleAr: data.pdfTitleAr || lessonForm.titleAr || file.name.replace('.pdf', ''),
                                pdfPages: 0,
                                isPdfLesson: true
                              }))
          ...
          {(editingType === 'category' || (contentType === 'categories' && !editingType)) && (
            <div className="space-y-4">
              ...
              {/* منتقي الأيقونات المتقدم */}
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <Label>الأيقونة</Label>
                  <div className="flex items-center gap-2">
                    <span className="text-sm text-gray-500">المختارة:</span>
                    <span className="text-2xl p-2 bg-gray-100 dark:bg-gray-800 rounded-lg">
                      {categoryForm.icon || '📁'}
                    </span>
                  </div>
                </div>
                ...
                {/* الأيقونات المصنفة */}
                <div className="max-h-64 overflow-y-auto border rounded-xl p-3 bg-gray-50 dark:bg-gray-900 space-y-4">
                      ...
                      <div className="grid grid-cols-10 gap-1">
                        {category.icons.map((icon, idx) => (
                          <button
                            ...
                            className={cn(
                              "p-2 text-xl rounded-lg transition-all hover:scale-110",
              ...
              <div>
                ...
                <div className="flex gap-1 mt-2 flex-wrap">
                  {['#F43F5E', '#F59E0B', '#8B5CF6', '#10B981', '#06B6D4', '#EC4899', '#22C55E', '#0EA5E9', '#D946EF', '#EF4444', '#6366F1', '#14B8A6'].map(color => (
                    <button
                      key={color}
                      type="button"
